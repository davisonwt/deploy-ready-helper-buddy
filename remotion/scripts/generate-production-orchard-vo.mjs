// Regenerates the Production Orchard VO with phonetic spelling so ElevenLabs
// pronounces "Sow to Grow" instead of spelling out "S-2-G".
...
const SCRIPT = {
  slug: "02-production-orchard",
  // Phonetic "Sow to Grow" + tighter copy to fit comfortably under 12s.
  text: "Sow to Grow Production Orchards turn ideas into supply. Open ten glowing pockets. At thirty percent funded, production starts and deliveries flow to happy customers. Plant a Production Orchard.",
};
...
const res = await fetch(
  `https://api.elevenlabs.io/v1/text-to-speech/${VOICE_ID}?output_format=${OUTPUT_FORMAT}`,
  {
    ...
    body: JSON.stringify({
      ...
      model_id: MODEL_ID,
      voice_settings: {
        stability: 0.45, similarity_boost: 0.8, style: 0.5,
