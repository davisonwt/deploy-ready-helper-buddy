// Generates the Radio Go-Live banner voiceover with ElevenLabs.
// Voice: George (JBFqnCBsd6RMkjVDRZzb) — upbeat radio-host energy.
...
const SCRIPT = {
  slug: "14-radio",
  text: "Go live on Sow2Grow Radio! Spin music, talk to the tribe, promote products and ads — free or with a small bestowal in USDT. Sign up on Sow2Grow.",
};
