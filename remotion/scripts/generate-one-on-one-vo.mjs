// Generates the 1-on-1 Chat banner voiceover with ElevenLabs.
...
const SCRIPT = {
  slug: "15-one-on-one",
  text: "Start a private one-on-one chat on Sow2Grow. Text, voice messages, video messages, voice and video calls — full control, all in your hands. Sign up on Sow2Grow.",
};
