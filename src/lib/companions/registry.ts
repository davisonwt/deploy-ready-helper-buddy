...
export const COMPANIONS: CompanionMeta[] = [
  {
    ...
    emoji: "🐧",
    summary: "Coordinates the orchard — briefings, routing, greetings.",
  ...
  },
  {
    ...
    emoji: "🎨",
    summary: "Drafts SeedFlow posts, captions, calendars and copy.",
    category: "content",
  ...
  },
  {
    ...
    emoji: "🛡️",
    summary: "Reviews tone and brand alignment before posting.",
    category: "review",
  ...
  },
  {
    ...
    emoji: "🪄",
    summary: "Creates seed covers, product photos and banners.",
    category: "image",
  ...
  },
  {
    ...
    emoji: "🎬",
    summary: "Plans reels, testimonial clips and orchard intros.",
    category: "video",
  ...
  },
  {
    ...
    emoji: "💬",
    summary: "Drafts outreach, thank-yous and collab invites.",
    category: "messaging",
  ...
  },
  {
    ...
    emoji: "📞",
    summary: "Opens HearthCall sessions and routes calls.",
    category: "calling",
  ...
  },
  {
    ...
    emoji: "📒",
    summary: "Bestowal reports, finance summaries, 1% tracking.",
    category: "finance",
  ...
  },
  {
    ...
    emoji: "🥖",
    summary: "Stock for Field & Forge, deliveries, orders.",
    category: "logistics",
  ...
  },
  {
    ...
    emoji: "🔮",
    summary: "Pricing, performance and best-time-to-post.",
    category: "insight",
