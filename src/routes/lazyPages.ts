...
export const StallsFeedPage = lazy(() => import('@/pages/StallsFeedPage'));
export const LiveNowPage = lazy(() => import('@/pages/LiveNowPage'));
export const ReceiptPage = lazy(() => import('@/pages/ReceiptPage'));
...
export const SowChooserPage = lazy(() => import('@/pages/sow/SowChooserPage'));
...
export const DisclaimerPage = lazy(() => import('@/pages/DisclaimerPage'));
export const MyOrdersPage = lazy(() => import('@/pages/MyOrdersPage'));
export const MySeedsPage = lazy(() => import('@/pages/MySeedsPage'));
...
export const SellerBusinessSettingsPage = lazy(() => import('@/pages/SellerBusinessSettingsPage'));
