  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-md p-8 rounded-2xl border border-white/40 shadow-2xl mb-8 mx-4 mt-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-white/60 backdrop-blur-md border-white/40 hover:shadow-xl transition-all duration-300 hover:scale-105">
          ...
          {/* Quick Actions */}
          <Card className="mt-8 bg-white/60 backdrop-blur-md border-white/40 shadow-xl">
          <CardHeader>
