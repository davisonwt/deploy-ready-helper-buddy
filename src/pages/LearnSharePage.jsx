...
const VIDEOS = [
  ...
  { id: 9,  role: 'Field',     title: 'Become a Wandering Field',   desc: 'How to list your farm produce',                    color: '#eab308', emoji: '🌾', url: VID('s2g harvest 1280x720 (1).mp4') },
  ...
  { id: 11, role: 'Hearth',    title: 'Become a Hearth Creator',    desc: 'How to list music, art, books & creations',        color: '#f97316', emoji: '🔥', url: VID('s2g fire 1280x720.mp4') },
  ...
  { id: 15, role: 'Heart',     title: 'Become a Wandering Heart',   desc: 'How to offer care & community support',            color: '#10b981', emoji: '💚', url: VID('s2g divine presence.mp4') },
  ...
  { id: 21, role: 'Platform',  title: 'How to Create a Seed',       desc: 'Step by step seed creation guide',                 color: '#0ea5e9', emoji: '🏛️', url: VID('seeds 2 mp4.mp4') },
  { id: 22, role: 'Platform',  title: 'Community Orchard Explained',desc: 'How tribe needs become community orchards',        color: '#0ea5e9', emoji: '🏛️', url: VID('orchards main mp4.mp4') },
  { id: 23, role: 'Platform',  title: 'Production Orchard Explained',desc:'How to fund a product into existence',             color: '#0ea5e9', emoji: '🏛️', url: VID('orchards 1a 1280x720.mp4') },
  ...
  { id: 28, role: 'Orchard',   title: 'Go Live on a Seed',          desc: 'How to host a live session for a seed',            color: '#16a34a', emoji: '🌳', url: VID('s2g upload sower 1280x720.mp4') },
  { id: 29, role: 'Orchard',   title: 'The Wandering Directory',    desc: 'How to find tribe members by role',                color: '#16a34a', emoji: '🌳', url: VID('seeds strip 1 8sec.mp4') },
  { id: 30, role: 'Orchard',   title: '364yhvh Calendar',           desc: 'How the sacred calendar works in S2G',             color: '#16a34a', emoji: '🌳', url: VID('s2g grow into blossoms, sunlight\'s love 1280x720.mp4') },
  { id: 31, role: 'Orchard',   title: 'Let It Rain',                desc: 'How to bestow blessings to the tribe',             color: '#16a34a', emoji: '🌳', url: VID('s2g let it rain bring the rainbow 1280x720.mp4') },
  { id: 32, role: 'Orchard',   title: 'The Music Library',          desc: 'How to upload and share your music',               color: '#16a34a', emoji: '🌳', url: VID('s2g sound 1280x720.mp4') },
  { id: 33, role: 'Orchard',   title: 'S2G Wallet Setup',           desc: 'How to set up USDC payments',                      color: '#16a34a', emoji: '🌳', url: VID('tithing 1280x720.mp4') },
  { id: 34, role: 'Orchard',   title: 'Become a Sower & Grower',    desc: 'The complete S2G onboarding guide',                color: '#16a34a', emoji: '🌳', url: VID('s2g  become a sower and grower (1).mp4') },
]
