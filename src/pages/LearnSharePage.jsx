...
const VIDEOS = [
  ...
  { id: 6,  role: 'Whisperer', title: 'Connect with a Whisperer',   desc: 'How to book / connect with a wandering whisperer', color: '#a855f7', emoji: '🌬️', url: null },
  ...
  { id: 21, role: 'Platform',  title: 'Sow a Single Seed',          desc: 'Step by step seed creation guide',                 color: '#0ea5e9', emoji: '🏛️', url: null },
  ...
  { id: 35, role: 'Platform',  title: 'Host a Live Classroom',      desc: 'How to host a live classroom session',             color: '#0ea5e9', emoji: '🏛️', url: null },
  { id: 36, role: 'Platform',  title: 'Open a Skilldrop Room',      desc: 'How to open a skilldrop room',                     color: '#0ea5e9', emoji: '🏛️', url: null },
  { id: 37, role: 'Platform',  title: 'Host a Training Session',    desc: 'How to host a live training session',              color: '#0ea5e9', emoji: '🏛️', url: null },
  { id: 38, role: 'Platform',  title: 'Host Your Own Radio Show',   desc: 'How to start your own radio show',                 color: '#0ea5e9', emoji: '🏛️', url: null },
  { id: 39, role: 'Platform',  title: 'Start a 1-on-1 Chat',        desc: 'How to start a private 1-on-1 chat',               color: '#0ea5e9', emoji: '🏛️', url: null },
  { id: 40, role: 'Platform',  title: 'Start an S2G Group Chat',    desc: 'How to start an S2G group call',                   color: '#0ea5e9', emoji: '🏛️', url: null },
