    ...
    <div className="min-h-screen bg-gradient-to-br from-success/10 via-background to-warning/10">
      ...
      <footer className="bg-card border-t border-border mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-foreground">About sow2grow</h3>
              <p className="text-sm text-muted-foreground">
                A community platform for growing faith, sharing resources, and supporting one another 
                in spreading the message of hope and love.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-foreground">Our Values</h3>
              <ul className="text-sm text-muted-foreground space-y-2">
                <li>• Community-driven support</li>
                <li>• Transparent giving</li>
                <li>• Faith-based growth</li>
                <li>• Collaborative learning</li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-foreground">Scripture</h3>
          ...
          <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>&copy; 2024 sow2grow | 364yhvh community farm</p>
          </div>
        </div>
      </footer>
      
      {/* Floating Features */}
      <GamificationFloatingButton 
        onClick={() => setShowGamificationHUD(!showGamificationHUD)} 
      />
      
      {showGamificationHUD && (
        <GamificationHUD onClose={() => setShowGamificationHUD(false)} />
      )}
      ...
      {showVoiceCommands && (
        <VoiceCommands 
          ...
          onToggle={setVoiceCommandsEnabled}
        />
      )}
    </div>
  )
