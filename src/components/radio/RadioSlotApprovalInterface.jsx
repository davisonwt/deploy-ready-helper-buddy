      ...
      <Card>
        ...
        <CardContent>
          <Tabs defaultValue="pending" className="w-full">
            <TabsList className="flex w-full gap-4 mb-6 bg-transparent p-0 h-auto">
              <TabsTrigger 
                value="pending" 
                className="flex-1 flex flex-col items-center justify-center h-auto p-4 bg-orange-50 dark:bg-orange-950/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-950/30 transition-colors data-[state=active]:bg-orange-200 dark:data-[state=active]:bg-orange-900/40 data-[state=active]:border-orange-400 border-2 border-transparent data-[state=active]:shadow-sm"
              >
              ...
              <TabsTrigger 
                value="approved" 
                className="flex-1 flex flex-col items-center justify-center h-auto p-4 bg-green-50 dark:bg-green-950/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-950/30 transition-colors data-[state=active]:bg-green-200 dark:data-[state=active]:bg-green-900/40 data-[state=active]:border-green-400 border-2 border-transparent data-[state=active]:shadow-sm"
              >
              ...
              <TabsTrigger 
                value="rejected" 
                className="flex-1 flex flex-col items-center justify-center h-auto p-4 bg-red-50 dark:bg-red-950/20 rounded-lg hover:bg-red-100 dark:hover:bg-red-950/30 transition-colors data-[state=active]:bg-red-200 dark:data-[state=active]:bg-red-900/40 data-[state=active]:border-red-400 border-2 border-transparent data-[state=active]:shadow-sm"
              >
