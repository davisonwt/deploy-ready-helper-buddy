...
export const GigActionCards: React.FC<GigActionCardsProps> = ({ theme }) => {
  ...
  const becomeCards = [
    { icon: Car, label: 'Become a Wondering Wheel', desc: 'Register vehicle', img: driverBecomeImg, href: '/register-vehicle', video: '/videos/register_vehicle.mp4' },
    ...
    { icon: BedDouble, label: 'Become a Wondering Pillow Provider', desc: 'List your property', img: '/images/gig/stays-become.jpg', href: '/list-your-stay' },
