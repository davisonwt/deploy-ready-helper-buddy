  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 z-[61] w-56 space-y-2"
          >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-20 right-4 z-[61] w-14 h-14 rounded-full shadow-2xl flex items-center justify-center"
        style={{
          background: open
