...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95 transform hover:scale-105 cursor-pointer relative overflow-visible before:absolute before:inset-0 before:bg-white before:opacity-0 hover:before:opacity-10 before:transition-opacity before:duration-300 after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-white after:to-transparent after:opacity-0 hover:after:opacity-20 after:transform after:skew-x-12 after:translate-x-full hover:after:translate-x-[-100%] after:transition-transform after:duration-700 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 button-neon-hover",
  {
    variants: {
      variant: {
