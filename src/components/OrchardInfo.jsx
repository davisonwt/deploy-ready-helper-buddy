...
export function OrchardInfo({ orchard, takenPockets = [] }) {
  ...
  return (
    <Card className="bg-white/95 backdrop-blur-sm border-green-200 shadow-xl">
      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-8 gap-4 text-center mb-6">
          <div className="bg-green-50 p-4 rounded-xl">
            <div className="text-xl font-bold text-green-800">{orchard.total_pockets || 0}</div>
            <div className="text-xs text-green-600">Total Pockets</div>
          </div>
          ...
          <div className="bg-emerald-50 p-4 rounded-xl">
            <div className="text-xl font-bold text-emerald-800">{growthStageCounts.sprout}</div>
            <div className="text-xs text-emerald-600">Sprout 🌱</div>
          </div>
          <div className="bg-lime-50 p-4 rounded-xl">
            <div className="text-xl font-bold text-lime-800">{growthStageCounts.young}</div>
            <div className="text-xs text-lime-600">Young 🌿</div>
          </div>
          <div className="bg-teal-50 p-4 rounded-xl">
            <div className="text-xl font-bold text-teal-800">{growthStageCounts.growing}</div>
            <div className="text-xs text-teal-600">Growing 🌳</div>
          </div>
          <div className="bg-green-50 p-4 rounded-xl">
            <div className="text-xl font-bold text-green-800">{growthStageCounts.mature}</div>
