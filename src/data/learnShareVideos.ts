...
export const VIDEOS: LearnVideo[] = [
  ...
  { id: 22, role: 'Platform',  title: 'Uplift Orchard Explained',   desc: 'How tribe needs become Uplift Orchards',           color: '#0ea5e9', emoji: '🏛️', url: communityOrchardVideo },
  { id: 23, role: 'Platform',  title: 'Launch Orchard Explained',   desc: 'How to fund a product into existence',             color: '#0ea5e9', emoji: '🏛️', url: productionOrchardVideo },
