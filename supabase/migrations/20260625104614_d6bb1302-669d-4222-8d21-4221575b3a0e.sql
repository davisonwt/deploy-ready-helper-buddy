...
-- Add metadata column to content_purchases for type-specific context (e.g. premium_item room_id/item_type)
ALTER TABLE public.content_purchases
  ADD COLUMN IF NOT EXISTS metadata jsonb NOT NULL DEFAULT '{}'::jsonb;

-- Extend finalize_content_purchase to grant access for all 5 Shape-1 content types.
...
BEGIN
  ...
  ELSIF p.content_type = 'music_track' THEN
    ...
    -- Chat-delivered receipt: notify buyer the track is in their library
