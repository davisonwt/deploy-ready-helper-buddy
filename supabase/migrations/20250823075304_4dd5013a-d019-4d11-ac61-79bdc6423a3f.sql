...
DROP POLICY IF EXISTS "Public can view orchard images" ON storage.objects;
DROP POLICY IF EXISTS "Public can view orchard videos" ON storage.objects;
DROP POLICY IF EXISTS "Public can view orchard audio" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can manage their own orchard images" ON storage.objects;
DROP POLICY IF EXISTS "Users can manage their own orchard videos" ON storage.objects;
DROP POLICY IF EXISTS "Users can manage their own orchard audio" ON storage.objects;

-- Create comprehensive RLS policies for public access to orchard media
...
CREATE POLICY "Public can view orchard videos"
ON storage.objects 
FOR SELECT 
USING (bucket_id = 'orchard-videos');

-- Policy for orchard audio
CREATE POLICY "Public can view orchard audio"
ON storage.objects 
FOR SELECT 
USING (bucket_id = 'orchard-audio');

-- Allow orchard creators to upload images
CREATE POLICY "Orchard creators can upload images"
ON storage.objects 
FOR INSERT 
WITH CHECK (
...
CREATE POLICY "Orchard creators can upload videos"
ON storage.objects 
FOR INSERT 
WITH CHECK (
...
CREATE POLICY "Orchard creators can upload audio"
ON storage.objects 
FOR INSERT 
WITH CHECK (
...
CREATE POLICY "Users can manage their own orchard images"
ON storage.objects 
FOR ALL
USING (
  bucket_id = 'orchard-images' 
...
CREATE POLICY "Users can manage their own orchard videos"
ON storage.objects 
FOR ALL
USING (
  bucket_id = 'orchard-videos' 
...
CREATE POLICY "Users can manage their own orchard audio"
ON storage.objects 
FOR ALL
USING (
  bucket_id = 'orchard-audio' 
